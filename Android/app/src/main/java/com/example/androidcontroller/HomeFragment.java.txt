...
public class HomeFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ImageButton controlBtnUpLeft = rootview.findViewById(R.id.upLeftArrowBtn);
        ImageButton controlBtnUp = rootview.findViewById(R.id.upArrowBtn);
        ImageButton controlBtnUpRight = rootview.findViewById(R.id.upRightArrowBtn);
//        ImageButton controlBtnLeft = rootview.findViewById(R.id.leftArrowBtn);
        ImageButton controlBtnDownLeft = rootview.findViewById(R.id.downLeftArrowBtn);
        ImageButton controlBtnDown = rootview.findViewById(R.id.downArrowBtn);
        ImageButton controlBtnDownRight = rootview.findViewById(R.id.downRightArrowBtn);
//        ImageButton controlBtnRight = rootview.findViewById(R.id.rightArrowBtn);

        // Insert functions to control diagonal/strafing movements below
...
//        });
        ...
        //CONTROL BUTTON: Strafe Left
        controlBtnUpLeft.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                if(event.getAction() == MotionEvent.ACTION_DOWN) {
                    sendDirectionCmdIntent("TL--");
        ...
        //CONTROL BUTTON: Strafe Right
        controlBtnUpRight.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                if(event.getAction() == MotionEvent.ACTION_DOWN) {
                    sendDirectionCmdIntent("TR--");
        ...
        //CONTROL BUTTON: Strafe Backwards Left
        controlBtnUpLeft.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                if(event.getAction() == MotionEvent.ACTION_DOWN) {
                    sendDirectionCmdIntent("BL--");
        ...
        //CONTROL BUTTON: Strafe Backwards Right
        controlBtnUpRight.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                if(event.getAction() == MotionEvent.ACTION_DOWN) {
                    sendDirectionCmdIntent("BR--");
        ...
        btnSendStartFastestCar.setOnClickListener(v->{
            ...
            sendTurningModeCmdIntent("start");
//            if(isBigTurn){
//                if(isOutdoor){
    ...
    private BroadcastReceiver robotLocationUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            try{
                ...
                Log.i(TAG, "sent to robotlocationupdatereceiver: " + msgJSON.toString());
