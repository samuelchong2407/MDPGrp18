...
public class BluetoothConnectionService {
    ...
    //public final class bluetoothManager = (BluetoothManager) getSystemService(Context.BLUETOOTH_SERVICE);

    public static volatile BluetoothConnectionService INSTANCE;

    private static final String appName = "MAP-GRP18-CONTROLLER";
    private static final UUID MY_UUID_INSECURE =
            UUID.fromString("49930a2c-04f6-4fe6-beb7-688360fc5995");
    private static final UUID rpiUUID = UUID.fromString("bd4a6e70-adfe-41d5-bd8d-0f737c20502e");
    ...
    private class AcceptThread extends Thread{
        ...
        public AcceptThread(){
            ...
            try{
                ...
                //temp = bluetoothAdapter.listenUsingInsecureRfcommWithServiceRecord(appName, rpiUUID);
        ...
        public void run(){
            ...
            for(ParcelUuid uuid:bluetoothDevice.getUuids()){
                ...
                try {
                    ...
                    tmp = bluetoothDevice.createRfcommSocketToServiceRecord(rpiUUID);
                } catch (IOException e) {
    ...
    private void handleIncomingBTMessage(String msg) throws JSONException {
        ...
        try{
            ...
            Log.i(TAG, "successfully jsonified:" + msg);
    ...
    private void handlePlainTextCommand(String cmd){
        ...
        try{
            ...
            Log.e(TAG, "handleIncomingBTMessage: An error occured while trying to handle plain text command");
            e.printStackTrace();
        }
    }
